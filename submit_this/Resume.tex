...
\section{Work Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Due to network latency and processing time, consolidation recomoendations take over \textbf{150ms} to retreive}
    ...
    {PAIR Lab}{Sep 2021 -- Present}{Researcher}{Toronto, Ontario}
      \resumeItemListStart
        ...
        \resumeItem{Utilized state-of-the-art techniques to solve \textbf{long-horizon robotics tasks} with minmal human input}
      \resumeItemListEnd
    \resumeSubheading
...
\section{Publications}
  \begin{itemize}[leftmargin=0.15in, label={}]
    \item{
    \small{\textbf{J. L. Yuan}\*, Z. Zhou\*, M. Skreta\*, K. Darvish, A. Aspuru-Guzik, A. Garg. Lidless Eye and Silver Tongue: using Vision and Language for Adaptive Task Replanning, \textit{ (ICLR) 2024}} [Under review]
    }
