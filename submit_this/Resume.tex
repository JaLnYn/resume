  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Designed and implemented a precompute layer to increase consolidation recommendations speed by \textbf{99\%}}
    ...
    {PAIR Lab}{Sep 2021 -- Present}{Researcher}{Toronto, Ontario}
      \resumeItemListStart
        \resumeItem{Built on top of \textbf{NVIDIA}'s Isaacsim to create a robot reinforcement learning \textbf{framework}}
        \resumeItem{Utilized state-of-the-art techniques to solve \textbf{long-horizon robotics tasks} with minimal human input}
      \resumeItemListEnd
    \resumeSubheading
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed flagship product using C++, Python and Bash for speedup by re-routing the compilation}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {MSc Applied Computing}{Sept 2023 - Jan 2025}
