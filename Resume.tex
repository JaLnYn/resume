...
\section{\faFlask}{Side Projects}
  \resumeEntryStart
    ...
    \resumeItemListStart
	  \resumeItem {Worked with \textbf{CFR, CFR+ and MCCFR} to train agents to find the nash equilibrium.}
	  \resumeItem {Utilized availible resources on the internet to learn these algorithms.}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
	  \resumeItem {Read articles and papers to understand \textbf{Q-Learning}}
 ...
 \resumeEntryStart
   ...
   \resumeItemListStart
     \resumeItem {Led a team of 4 to create a web-chat-app that matches strangers based on their current emotion determined by \textbf{Azure ML API}}
