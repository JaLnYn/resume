...
\begin{itemize}[leftmargin=0.15in, label={}]
    \item{
    \textbf{J. L. Yuan}, Z. Zhou, K. Darvish, X. Zhou, A. Mandlekar, A. Garg,  (Under Review), \textit{CoRL 2023}
    }
 \end{itemize}
\section{Publications}
\begin{itemize}[leftmargin=0.15in, label={}]
    \item{
    M. Mittal, C. Yu, Q. Yu, J. Liu, N. Rudin, D. Hoeller, \textbf{J. L. Yuan}, R. Singh, Y. Guo, H. Mazhar, A. U. Mandlekar, B. Babich, G. State, M. Hutter, A. Garg, "ORBIT: A Unified Simulation Framework for Interactive Robot Learning Environments", \textit{IEEE Robotics and Automation Letters (RA-L) 2023}
    }
 \end{itemize}
...
\section{Projects}
    \resumeSubHeadingListStart
        \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Collaborate with \textbf{Nvidia} to build on top of Isaacsim creating a robot reinforcment learning \textbf{benchmark}}
            \resumeItem{Implementing a task-flow and enviroment randomizer for \textbf{causal reward} and \textbf{long-horizon task} based research}
