...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {SDE}{Toronto, Ontario}
      \resumeItemListStart
        \resumeItem{Automating and consolidating backups for \textbf{AWS} resources resulting in \$1M reduction in backup costs per year.}
        \resumeItem{Built tooling to backfill data for the \textbf{DynamoDB-Snowflake CDC} pipeline allowing teams to fill missing data.}
      \resumeItemListEnd
    \resumeSubheading
