...
\section{Work Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Train \textbf{times-series transfomer} models to \textbf{forecast sales} in various regions with \textbf{PyTorch}. }
        \resumeItem{\textbf{Optimize sales prices} and promotion weeks with genetic algorithms utilizing \textbf{NGSAII}.}
        \resumeItem{Increased model accuracy by \textbf{5\%} by utilizing state of the art techniques and modifying existing architecture.}
        \resumeItem{Implemented multi-thread processing to increase data pipline speeds by \textbf{150\%}.}
      \resumeItemListEnd
    \resumeSubheading
...
\section{Projects}
    \resumeSubHeadingListStart
      ...
      %     \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{Decomposed Face Generation}  $|$ \href{https://github.com/JaLnYn/talkinghead}{github}}{Apr 2024 -- Present}
          \resumeItemListStart
