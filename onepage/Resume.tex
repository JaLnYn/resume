  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Designed and implemented a precompute layer to increase recommendations speed by \textbf{99\%} from 150ms}
    ...
    {PAIR Lab}{Sep 2021 -- Present}{Researcher}{Toronto, Ontario}
      \resumeItemListStart
        \resumeItem{Exploring the usage of \textbf{MPC}, \textbf{VLM}, \textbf{LLM} in long term planning of low level tassk through constant re-evaluation of plans resulting in the completion of multi-step class instructed by english}
...
\section{Projects}
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Mined dataset and trained an ensemble of \textbf{Computer Vision} models: \textbf{ResNet}, \textbf{EfficientNet} and \textbf{Vision Transformer} resulting in a \textbf{47\%} improvment over random agent in predicting province of image in provinces}
          \resumeItemListEnd
      \resumeProjectHeading
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Deep Neural Networks, Large Language Models, Latent Diffusion Models, Robotics} \\
     \textbf{Languages}{: Python, C/C++, JavaScript, Java, C\#} \\
     \textbf{Tools}{: Huggingface, Oobabooga, PyTorch, Git, React Native, Node.js, MongoDB, SQL (Postgres), Numpy, GraphQL} \\
    }}
 \end{itemize}
