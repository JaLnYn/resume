...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    {PAIR Lab}{Sep 2021 -- Present}{Researcher}{Toronto, Ontario}
      \resumeItemListStart
        \resumeItem{Exploring the usage of \textbf{MPC}, \textbf{VLM}, \textbf{LLM} in long term planning of low level task through constant re-evaluation of plans resulting in the completion of multi-step tasks instructed by english, improving on state of the art}
        \resumeItem{Assisted with \textbf{Orbit}, a robotics learning framework built on top of NVIDIA's \textbf{Isaacsim} resulting in a publication}
