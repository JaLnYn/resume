...
\section{Work Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Train \textbf{times-series transfomer} models to predict sales in various regions with \textbf{PyTorch}. }
        \resumeItem{Optimize sales and promotion weeks with genetic algorithms utilizing \textbf{NGSAII}.}
