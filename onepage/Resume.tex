...
\section{Work Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Increased model accuracy by \textbf{15\%} by changing model architecture and finetuning hyperparameters.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Designed and implemented a precompute layer to increase recommendation speed by \textbf{99\%} from 150ms}
    ...
    \resumeSubheading
      ...
      \resumeItemListEnd
    \resumeSubheading
      {PAIR Lab (Robotics)}{Sep 2021 -- Apr 2024}{Researcher}{Toronto, Ontario}
      \resumeItemListStart
        \resumeItem{Use of \textbf{MPC}, \textbf{MultiModal LLM} in completing high level robot tasks prompted by text $|$ \href{https://arxiv.org/abs/2401.04157}{arXiv:2401.04157}}
        \resumeItem{Contributed to \textbf{Orbit}, a robot learning framework built on \textbf{NVIDIA Isaacsim}. Published in \textit{RAL} $|$ \href{https://isaac-orbit.github.io/}{project-site}}
