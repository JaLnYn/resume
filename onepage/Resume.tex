...
\section{Work Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListEnd
    \resumeSubheading
    {PAIR Lab (Robotics)}{Sep 2021 -- Present}{Researcher}{Toronto, Ontario}
      \resumeItemListStart
        \resumeItem{Exploring the usage of \textbf{MPC}, \textbf{MultiModal LLM} in long-term planning of low level task through constant re-evaluation of plans, improving on state of the art: \href{https://arxiv.org/abs/2401.04157}{arXiv:2401.04157}}
        ...
        \resumeItem{Assisted with \textbf{Orbit}, a robot learning framework built on top of \textbf{NVIDIA's Isaacsim} resulting in a publication}
...
\section{Projects}
    \resumeSubHeadingListStart
      ...
      %   \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{MultiModal AI Story teller (Co-Founder)}  $|$ private repo}{Jul 2023 -- Present}
          \resumeItemListStart
            ...
            \resumeItem{Grew project from 0 to 50 daily active users resulting in 2k in profits.}
          \resumeItemListEnd
      \resumeProjectHeading
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Tools}{: Huggingface, Oobabooga, PyTorch, Git, React, Node.js, MongoDB, SQL, Numpy, GraphQL, Robotics, } \\
    }}
 \end{itemize}
