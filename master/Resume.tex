...
\section{Work Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Software Developer - Intern}{Vancouver, Ontario}
      \resumeItemListStart
        \resumeItem{Implemented system to read customer orders and send real-time notifications based on eligibility criterias}
        \resumeItem{Ensured modularity by designing a plugin system for processing the customer orders}
        \resumeItem{Utilize \textbf{AWS} webservices such as \textbf{Lambda}, \textbf{SQS} and \textbf{SNS} to ensure scalability}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Developing support software to generate 4000+ of completely random test-cases for edge-case testing}
        ...
        \resumeItem{Migrating all 613 failing regression test cases from pre-existing compilation flow to the new faster flow}
      \resumeItemListEnd
...
\section{Projects}
    \resumeSubHeadingListStart
        \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Utilizing Nvidia's Omniverse to create a robot reinforcment learning benchmarker}
            \resumeItem{Implementing a task-flow and enviroment randomizer for causal reward based research}
            \resumeItem{Creating physics scenes and testing R.L algorithms to be used as a benchmark in future papers}
          \resumeItemListEnd
      ...
      \resumeProjectHeading
        ...
        \resumeItemListStart
          \resumeItem{Created a four player game for local networks using the UDP network protocol and C\texttt{++}}
      ...
      \resumeProjectHeading
        ...
        \resumeItemListStart
          \resumeItem{Built interpreter that runs BF in C}
          \resumeItem{Reads user input in real-time as BF shell and reads BF files}
          \resumeItem{Runs all example BF programs found on wikipedia}
        \resumeItemListEnd
    \resumeSubHeadingListEnd
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Tools}{: Git, React Native, Node.js, MongoDB, SQL (Postgres), PyTorch, Numpy, Pandas, GDB} \\
    }}
 \end{itemize}
