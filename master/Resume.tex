    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Utilized state-of-the-art SEA algorithm to solve \textbf{long-horizon tasks}}
            \resumeItem{Creating physics scenes and testing \textbf{reinforcment learning} algorithms to be used as a benchmark}
            \resumeItem{Utilized \textbf{PyTorch} and \textbf{PPO} implementations such as \textbf{rslrl}, \textbf{rlgames} and \textbf{rllib}}
            \resumeItem{Setup controllers and trained a variaty of robots including \textbf{frankas and mobile manipulators}}
            \resumeItem{Extended the physics engine with \textbf{Semantic States} within the robotic simulator for more complex enviroments.}
          \resumeItemListEnd
        ...
        \resumeProjectHeading
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{Introduction to Machine Learning Course Competition} $|$ Link: \href{https://github.com/JaLnYn/csc311_final_project/tree/main/project/starter_code}{GitHub}}{Sep 2020 -- Dec 2020}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
        ...
        \resumeItemListStart
          ...
          \resumeItem{Played the snake game with DQL agent reaching a high score of \textbf{40} after \textbf{5} minutes of training}
        \resumeItemListEnd
        \resumeProjectHeading
        {\textbf{CFR Minimization (Kuhn Poker, Tic-Tac-Toe and Coup)} $|$ Link: \href{https://github.com/JaLnYn/pokerbot}{GitHub}}{May 2021 -- Jul 2021}
