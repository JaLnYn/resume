...
\section{Work Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Implemented system in \textbf{Java} to read customer orders and send real-time notifications based on eligibility criterias}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed Quartus using \textbf{C\texttt{+}\texttt{+}}, \textbf{Python} and \textbf{Bash} for speedup during synthesis by re-routing the compilation}
        ...
        \resumeItem{Migrated all 613 failing regression test cases from pre-existing compilation to the new faster flow}
      \resumeItemListEnd
...
\section{Projects}
    \resumeSubHeadingListStart
        \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Utilizing Nvidia's Isaacsim to create a robot reinforcment learning benchmarker}
            ...
            \resumeItem{Setup and trained a variaty of robots including frankas and mobile manipulators}
          \resumeItemListEnd
